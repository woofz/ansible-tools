...
class support_vector_machine:
    ...
    def doc2vec(self):
        ...
        d2v_model_tasks = Doc2Vec(tagged_data_tasks_train, dm=1, window=5, min_count=1, alpha = 0.025,
...
if __name__ == "__main__":
    ...
    with open('C:\\mutated.pkl', 'rb') as input_file:
        mutated = pickle.load(input_file)
        
    with open('C:\\top10_list.pkl', 'rb') as input_file:
